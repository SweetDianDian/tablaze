...
- Current full local regression: **471/471 passed**, with no failures, skips or cancellations. This includes the delayed-target Chrome test, typed custom-tool SDK, browser context keys and bound checkpoint recovery; scripted fixtures do not measure general model ability.
