...
- Current full local regression: **318/318 passed**, with no failures, skips or cancellations. This includes the typed custom-tool SDK, browser context keys and bound checkpoint recovery; scripted fixtures do not measure general model ability.
