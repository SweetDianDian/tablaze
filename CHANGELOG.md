...
- Current full local regression on Node 24.19.0: **476/476 passed**, with no failures, skips or cancellations. This includes real-Chrome recording checks, delayed-target controls, typed custom tools, browser context keys and bound checkpoint recovery; scripted fixtures do not measure general model ability.
