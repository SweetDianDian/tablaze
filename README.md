...
CLI Agent and stdio MCP uploads now use a [trusted file list](docs/FILE_POLICY.md): no host files are available by default, `--available-file` grants specific files, and same-session downloads can be uploaded by ID.
