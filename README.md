...
The initial iframe observation now gives newly attached child frames a bounded readiness wait; a real-Chrome regression confirms the first `tab_open` can expose a delayed child form.
