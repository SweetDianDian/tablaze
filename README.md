...
Action feedback now retains the operated child frame after such a failed post-check, allowing the next decision to inspect the right page without another frame-switch snapshot. This later change still needs its own model comparison.
