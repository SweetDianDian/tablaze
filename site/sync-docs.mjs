...
for (const name of [
  ...
  'agent-long-history-20260924.jsonl', 'development-tests-long-history-node24.txt', 'development-tests-proxy-routes-node24.txt', 'development-tests-proxy-cli-node24.txt',
