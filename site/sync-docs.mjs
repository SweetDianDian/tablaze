...
for (const name of [
  'development-tests.txt', 'development-tests-2026-09-23.txt', 'development-tests-auth-return.txt', 'development-tests-profile.txt', 'development-tests-click-named.txt', 'development-tests-recording-node24.txt', 'development-tests-control-state-node24.txt', 'development-tests-browser-config-node24.txt', 'development-tests-proxy-node24.txt', 'development-tests-iframe-readiness-node24.txt', 'development-validation.json',
