...
export function installVisualPointer(): void {
  ...
  const install = () => {
    ...
    shadow.innerHTML = '<style>:host{pointer-events:none!important}svg{position:absolute;left:-10px;top:-10px;width:40px;height:40px;overflow:visible;filter:drop-shadow(0 2px 4px #0009);pointer-events:none!important}.ring{fill:#fa6a36;fill-opacity:.2;stroke:#fa6a36;stroke-width:2}.cursor{fill:#fff;stroke:#1b2530;stroke-width:2;stroke-linejoin:round}</style><svg viewBox="0 0 40 40" aria-hidden="true"><circle class="ring" cx="14" cy="14" r="11"/><path class="cursor" d="M14 11v23l5.5-5.9 4.5 8.3 3.9-2.1-4.5-8.2 8-1.3z"/></svg>';
